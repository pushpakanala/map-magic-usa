...
const LandingPage = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      gradientClass: "from-uniquestPurple to-uniquestPurple-dark",
                    ...
                    >
                      <CardContent className="bg-[#111827] rounded-lg h-full p-6 flex flex-col">
                        <div className="flex items-center mb-4">
                          ...
                          {idx === 2 && (
                            <BarChart className="w-5 h-5 text-uniquestPurple mr-2" />
                          )}
                        ...
                        {idx === 2 && (
                          <div className="flex-1 flex flex-col">
                            <div className="bg-gradient-to-br from-uniquestPurple/10 to-uniquestPurple/5 p-4 rounded-lg mb-6">
                              <div className="flex gap-2 mb-3">
                                <div className="flex-1 py-2 px-3 rounded bg-white/5 backdrop-blur-sm border border-white/10">
                                  <div className="flex items-center">
                                    <School className="h-4 w-4 text-uniquestPurple mr-2" />
                                ...
                                <Button 
                                  variant="ghost" 
                                  size="icon" 
                                  className="w-8 h-8 rounded-full bg-uniquestPurple/10 border border-uniquestPurple/20"
                                >
                                  <Check className="h-4 w-4 text-uniquestPurple" />
                                </Button>
                              </div>
                              <div className="flex gap-2 mb-3">
                                <div className="flex-1 py-2 px-3 rounded bg-white/5 backdrop-blur-sm border border-white/10">
                            ...
                            <div className="mt-auto">
                              <Button 
                                className="w-full bg-gradient-to-r from-uniquestPurple to-uniquestPurple-dark hover:opacity-90 text-white"
                              >
                                {card.buttonText}
                              </Button>
                              
                              <div className="flex justify-between mt-4">
                                <div className="flex items-center text-xs text-uniquestPurple">
                                  <CheckCircle className="w-4 h-4 mr-1" />
                                  Side-by-side
                                </div>
                                <div className="flex items-center text-xs text-uniquestPurple">
